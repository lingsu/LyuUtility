...
namespace Lyu.Web.Framework.UI
{
    public static class LayoutExtensions
    {
        ...
        public static MvcHtmlString LyuTitle(this HtmlHelper html, bool addDefaultTitle, string part = "")
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
        ...
        /// <param name="part">Meta description part</param>
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuMetaDescription(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
        ...
        /// <param name="part">Meta keyword part</param>
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuMetaKeywords(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
        ...
        public static HtmlHelper AddScriptFootParts(this HtmlHelper html, string part, bool excludeFromBundle = false)
        {
            AddScriptParts(html, ResourceLocation.Foot, part, excludeFromBundle);
            return html;
        }
        /// <summary>
        /// Add script element
        ...
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuScripts(this HtmlHelper html, UrlHelper urlHelper,
        ...
        /// <param name="bundleFiles">A value indicating whether to bundle script elements</param>
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuCssFiles(this HtmlHelper html, UrlHelper urlHelper,
            ResourceLocation location, bool? bundleFiles = null)
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
        ...
        /// <param name="part">Canonical URL part</param>
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuCanonicalUrls(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
        ...
        /// <param name="html">HTML helper</param>
        /// <returns>Generated string</returns>
        public static MvcHtmlString LyuHeadCustom(this HtmlHelper html)
        {
            var pageHeadBuilder = IocManager.Instance.Resolve<IPageHeadBuilder>();
