...
namespace Lyu.Utility.Secutiry
{
    /// <summary>
    /// 结合RSA，DES的通信加密解密操作类
    /// </summary>
    public class CommunicationCryptor
    {
        ...
        public CommunicationCryptor(string ownPrivateKey, string facePublicKey, string hashType)
        {
            ...
            {
                throw new Exception("Security_RSA_Sign_HashType");
            }
        ...
        public string EncryptData(string data)
        {
            ...
            data = new[] { data, signData }.Join(Separator);
            //使用DES加密 正文+摘要
            ...
            return new[] { enDesKey, data }.Join(Separator);
        }
    }
}